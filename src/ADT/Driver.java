...
public class Driver {
  ...
  public static void testDictionary() {
    ...
    Name bogus = new Name("Bo", "Gus");
        ...
        Name a = new Name("Zoo", "");
    Name b = new Name("Zion", "");
    Name c = new Name("Lanci", "");
    Name d = new Name("BoPia", "Gus");
    
        Name e = new Name("Queen", "");
    Name f = new Name("Yoo", "Gus");
...
// test add		
    ...
    nameList.add(a, "555-7890");
    nameList.add(b, "555-2345");
    nameList.add(c, "555-7891");
    nameList.add(d, "555-7892");
    nameList.add(e, "555-7891");
    nameList.add(f, "555-7892");
